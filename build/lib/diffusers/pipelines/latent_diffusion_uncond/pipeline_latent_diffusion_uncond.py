    ...
    def __call__(
        ...
        **kwargs,
        ...
        for t in self.progress_bar(self.scheduler.timesteps):
            ...
            # fig = plt.hist(latents.cpu().flatten(), bins=100, range=(-10, 10))
            # plt.savefig(os.path.join('latent_2d', str(t) + '-histgram.png'))
        # adjust latents with inverse of vae scale
        latents = latents / self.vqvae.config.scaling_factor
        # fig = plt.hist(latents.cpu().flatten(), bins=100, range=(-50, 50))
        # plt.savefig(os.path.join('latent_2d', 'final-histgram.png'))
